...
##! For stability purposes I've hardcoded IGVjs to version 2.3.5 --> https://github.com/igvteam/igv.js/releases/tag/v2.3.5
git checkout 0a465785d1426006ff85555f7972ddee0a22ff18 --quiet
