#!/usr/bin/env python3
"""
Thierry Janssens, 28MAY2019
Average the evalues from the filtered gff file (mgkit)
Usage:
  average_logevalue.py <input_taxtab> <input_gff> <output_taxtab>
<input_taxtab> is the file generated by mgkit taxon-utils lca (made tmp()).
<input_stat> is the file generated by mgkit filter-gff.
<output> is the input taxtab amended with a column with an average log evalue for every LCA (contig).
"""
...
SCRIPT, INPUTTAX, INPUTGFF, OUTPUTFILE = argv
